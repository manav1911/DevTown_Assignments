...
const listItemComplete = (todo_text = "") => ` 
...
const addRemoveEventListener = (todoElement, ele) => {
    ...
    removeBtn.addEventListener("click", () => {
        ...
        listState.innerHTML = todos.length >= 1 ? `Hello, here are your latest` : `There are no tasks to be completed!`
